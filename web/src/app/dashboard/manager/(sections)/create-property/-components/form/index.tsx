...
import { PropertyParamSchema, type PropertyParams } from "../../-schemas/property-param.schema";
...
export const CreatePropertyForm=({className, handleSubmit, isRequestPending, ...props}: CreatePropertyFormProps)=> {
  ...
  return(
      ...
      >
        ...
        {/* Details */}
        <h2 className="text-lg font-semibold mt-6 mb-2">Details</h2>
        ...
        <h2 className="text-lg font-semibold mt-6 mb-2">Amenities & Highlights</h2>
        <appForm.AppField name="amenities">
          {(field) => <field.ToggleGroupField labelName="Amenities" options={AmenityTypeEnum.options} />}
        </appForm.AppField>
        <appForm.AppField name="highlights">
          {(field) => <field.ToggleGroupField labelName="Highlights" options={HighlightTypeEnum.options} />}
        </appForm.AppField>
