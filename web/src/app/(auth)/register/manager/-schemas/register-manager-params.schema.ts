...
export const managerRegisterationFormParamSchema = z.object({
...
export type ManagerRegisterationFormParams = z.input<typeof managerRegisterationFormParamSchema>